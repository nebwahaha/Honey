...
export const darkTheme: Theme = {
  name: 'dark',
  // Deep navy base with honey-gold accents
  pageBg: '#0a0f1e',
  text: '#b8c4d8',
  scrollbarThumb: '#1c2640',
  sidebarBg: '#080c18',
  sidebarBorder: '#151d35',
  brand: '#e09830',
  navText: '#6a7a98',
  navActiveBg: '#1a2540',
  navActiveText: '#e09830',
  cardBg: '#111828',
  cardBorder: '#1c2640',
  cardHoverBg: '#182038',
  cardHoverBorder: '#2a3a5a',
  iconAccentBg: '#1a2235',
  iconAccent: '#e09830',
  heading: '#f0e6d6',
  textPrimary: '#b8c4d8',
  ...
  barCursor: 'rgba(224, 152, 48, 0.08)',
  sessionClosed: '#6a7a98',
  tcpTunnel: '#c8a060',
  fileDownload: '#ff7b72',
  blockStatusActiveBg: '#2d1b1b',
  blockStatusInactiveBg: '#111828',
  notifItemBg: '#0e1322',
  toggleActiveBorder: '#e09830',
  toggleActiveText: '#e09830',
  toggleInactiveBorder: '#2a3a5a',
  toggleInactiveText: '#5a6a85',
  toggleDisabledBg: '#1c2640',
